...
/*  $fname=$_POST['fname'];
  ...
  /*$count="select * from employee_details_table";
  ...
  $sql1="insert into employee_details_table(employee_id,employee_first_name,employee_last_name,graduation_percentile)
  values ('$data', '$fname','$lname','$percentile')";
